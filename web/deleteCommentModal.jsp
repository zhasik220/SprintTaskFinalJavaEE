<button class="btn btn-outline-danger " type="button"
        data-bs-toggle="modal" aria-haspopup="true" data-bs-target="#<%= (char)('a'+comment.getId())%>deleteComment"
        aria-expanded="false">
    <i class="bi bi-trash"></i>
</button>


<div class="modal fade" id="<%=(char) ('a'+comment.getId())%>deleteComment" tabindex="-1"
