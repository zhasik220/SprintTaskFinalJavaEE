...
<button class="btn btn-outline-primary " type="button"
        data-bs-toggle="modal" aria-haspopup="true" data-bs-target="#<%=(char) ('a'+comment.getId())%>updateComment" aria-expanded="false">
    <i class="bi bi-pencil"></i>
</button>

<div class="modal fade" id="<%=(char) ('a'+comment.getId())%>updateComment" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
